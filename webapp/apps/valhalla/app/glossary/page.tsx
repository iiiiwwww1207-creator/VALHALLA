...
const glossary = [
  ...
  },
  {
    term: '飲み直し（のみなおし）',
    reading: 'のみなおし',
    short: '送り指名のタイミングで指名に切り替えること',
    detail:
      '送り指名を選んだタイミングで、そのまま帰らずに指名に切り替えること。クイック・通常・飲み放題などのシステムを選んで、改めて指名として飲み続けるスタイル。飲み直しをしない場合はそのまま送りに移ります。',
    emoji: '🍾',
  },
  {
    term: 'クイック',
  ...
  },
  {
    term: '相伴（あいばん）',
    reading: 'あいばん',
    short: '友達同士でそれぞれ別の指名ホストがいる状態',
    detail:
      '友達同士で来店したとき、自分にも友達にもそれぞれ指名しているホストがいて、複数のホストが同じ席につく状態のこと。それぞれが自分の担当と過ごしながら、みんなで一緒に盛り上がれる。',
    emoji: '👥',
  },
  {
    term: '場内指名（じょうないしめい）',
  ...
  },
  {
    ...
    short: 'お会計のこと',
    detail:
      'ホストクラブでのお会計のこと。「チェックお願いします」と言えばお会計の合図。退店前に担当ホストや店員に伝えます。',
    emoji: '🧾',
  },
];
