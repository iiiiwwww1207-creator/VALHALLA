...
const glossary = [
  ...
  },
  {
    term: 'かぶり',
    reading: 'かぶり',
    short: '同じ担当を指名している指名同士のこと',
    detail:
      '同じホストを担当として指名しているお客様同士のこと。同じ担当を持つ者同士なので、お店で鉢合わせることも。かぶりの存在を知ることで、担当との関係性をより深く理解できます。',
    emoji: '👯',
  },
  {
    term: '同伴（どうはん）',
  ...
  },
  {
    term: 'ラスソン',
    reading: 'らすそん',
    short: 'お店が閉まる直前に流れる最後の曲',
    detail:
      '「ラストソング」の略。閉店時間が近づくと流れる特別な曲のことで、「もうすぐ終わりですよ」というサイン。ラスソンが流れたら退店の準備を始めるタイミング。ホスト同士・お客さん同士で盛り上がることも多い。',
    emoji: '🎵',
  },
];
