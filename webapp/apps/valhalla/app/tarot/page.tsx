    ...
    <main className="min-h-dvh bg-[#070509] text-[#F5EFE0]" style={{ fontFamily: 'var(--font-body)' }}>
      ...
      <div className="relative z-10 max-w-[480px] mx-auto px-5 pb-10">
        ...
        <div className="text-center py-12">
          <p className="text-[10px] tracking-[0.5em] text-[#C9A961] mb-4 uppercase" style={{ fontFamily: 'var(--font-cinzel)' }}>TAROT</p>
          <div className="text-5xl mb-6">🔮</div>
          <h1 className="text-2xl font-bold text-[#E8CB85] mb-4" style={{ fontFamily: 'var(--font-cinzel)' }}>タロット占い</h1>
          <p className="text-sm text-[rgba(245,239,224,0.55)] leading-7 whitespace-pre-line">Group Yggdrasill人気キャストに\n占ってもらおう</p>
        </div>
